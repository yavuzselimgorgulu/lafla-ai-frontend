...
export function DialogPublish() {
  ...
  const shareOnX = () => {
    ...
    const X_TEXT = `Lafla ile oluşturduğum bu herkese açık sayfaya göz atın! ${publicLink}`
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            ...
            <span className="sr-only">Herkese açık yap</span>
          </Button>
        </TooltipTrigger>
        <TooltipContent>
          <p>Herkese açık yap</p>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
  )
      ...
      <>
        ...
        <Drawer open={openDialog} onOpenChange={setOpenDialog}>
          <DrawerContent className="bg-background border-border">
            <DrawerHeader>
              <DrawerTitle>Konuşmanız artık herkese açık!</DrawerTitle>
              <DrawerDescription>
                Bağlantıya sahip olan herkes artık bu konuşmayı görüntüleyebilir ve gelecekte topluluk akışlarında, öne çıkan sayfalarda veya arama sonuçlarında görünebilir.
              </DrawerDescription>
            </DrawerHeader>
    ...
    <>
      ...
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>Konuşmanız artık herkese açık!</DialogTitle>
            <DialogDescription>
              Bağlantıya sahip olan herkes artık bu konuşmayı görüntüleyebilir ve gelecekte topluluk akışlarında, öne çıkan sayfalarda veya arama sonuçlarında görünebilir.
            </DialogDescription>
          </DialogHeader>
