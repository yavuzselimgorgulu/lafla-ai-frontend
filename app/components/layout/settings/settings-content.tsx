      ...
      >
        {isDrawer ? (
          ...
          <div className="w-full items-start justify-start overflow-hidden py-4">
            ...
            {/* Mobile tabs content */}
            <TabsContent value="Genel" className="space-y-6 px-6">
              <UserProfile />
              {isSupabaseEnabled && (
                <>
                  <AccountManagement />
            ...
            <TabsContent value="Görünüm" className="space-y-6 px-6">
              <ThemeSelection />
              <LayoutSettings />
              <InteractionPreferences />
            </TabsContent>

            <TabsContent value="API Anahtarları" className="px-6">
              <ByokSection />
            </TabsContent>

            <TabsContent value="Modeller" className="px-6">
              <ModelsSettings />
              {/* <ModelVisibilitySettings /> */}
            </TabsContent>

            <TabsContent value="Bağlantılar" className="space-y-6 px-6">
          ...
          <>
            ...
            <div className="flex-1 overflow-auto px-6 pt-4">
              ...
              <TabsContent value="Görünüm" className="mt-0 space-y-6">
                <ThemeSelection />
                <LayoutSettings />
                <InteractionPreferences />
              </TabsContent>

              <TabsContent value="Api Anahtarları" className="mt-0 space-y-6">
                <ByokSection />
              </TabsContent>

              <TabsContent value="Modeller" className="mt-0 space-y-6">
                <ModelsSettings />
                {/* <ModelVisibilitySettings /> */}
              </TabsContent>

              <TabsContent value="Bağlantılar" className="mt-0 space-y-6">
                {!isDev && <ConnectionsPlaceholder />}
                {isDev && <OllamaSection />}
                {isDev && <DeveloperTools />}
              </TabsContent>
