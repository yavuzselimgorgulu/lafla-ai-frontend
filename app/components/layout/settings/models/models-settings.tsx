...
export function ModelsSettings() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="mb-2 text-lg font-medium">Modeller</h3>
        <p className="text-muted-foreground mb-4 text-sm">
          Seçicinizde gösterilen modelleri yeniden sıralayın ve yönetin.
        </p>
      </div>
      ...
      <div>
        <h4 className="mb-3 text-sm font-medium">
          Favorileriniz ({favoriteModels.length})
        </h4>
          ...
          {favoriteModels.length > 0 ? (
                      ...
                      <button
                        ...
                        title={
                          favoriteModels.length <= 1
                            ? "En az bir favori model gereklidir"
                            : "Favorilerden kaldır"
                        }
                      >
            ...
            >
              <div className="text-center">
                ...
                <p className="text-sm">Henüz favori model yok</p>
                <p className="text-xs">Aşağıdaki listeden modeller ekleyin</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
      ...
      <div>
        ...
        <p className="text-muted-foreground mb-4 text-sm">
          Favorilerinize eklemek istediğiniz modelleri seçin.
        </p>
        ...
        {Object.keys(availableModelsByProvider).length === 0 && (
          <div className="text-muted-foreground py-8 text-center text-sm">
            {searchQuery
              ? `Eşleşen model bulunamadı "${searchQuery}"`
              : "Eklenecek mevcut model yok"}
          </div>
        )}
      </div>
    </div>
