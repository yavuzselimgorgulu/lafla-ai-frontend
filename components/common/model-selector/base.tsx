  ...
  const trigger = (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span>{currentModel?.name || "Model Seçin"}</span>
      </div>
    ...
    return (
      <Popover>
        <Tooltip>
          ...
          <TooltipContent>Bir model seçin</TooltipContent>
        </Tooltip>
        <PopoverContentAuth />
      </Popover>
    )
    ...
    return (
      <>
        ...
        <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
          ...
          <DrawerContent>
            <DrawerHeader>
              <DrawerTitle>Modelleri seçin</DrawerTitle>
            </DrawerHeader>
    ...
    <div>
      ...
      <Tooltip>
        ...
        >
          ...
          <TooltipContent>Modeli Değiştir ⌘⇧P</TooltipContent>
          <DropdownMenuContent
