          ...
          <TooltipTrigger asChild>
            <PopoverTrigger asChild>
              <Button
                ...
                type="button"
              >
                <span>Modelleri seçin</span>
                <CaretDownIcon className="size-4" />
              </Button>
            </PopoverTrigger>
          </TooltipTrigger>
          <TooltipContent>Modelleri seçin</TooltipContent>
        </Tooltip>
        <PopoverContentAuth />
      </Popover>
    )
      ...
      <div>
        ...
        <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
          ...
          <DrawerContent>
            <DrawerHeader>
              <DrawerTitle>
                Modelleri seçin ({selectedModelIds.length}/{maxModels})
              </DrawerTitle>
            </DrawerHeader>
    ...
    <div>
      ...
      <Tooltip>
        ...
        >
          ...
          <TooltipContent>
            Modelleri Seçin ⌘⇧M ({selectedModelIds.length}/{maxModels})
          </TooltipContent>
          <DropdownMenuContent
